...
import defaultAvatar from "../../../assets/defaultAvatarUser.jpg"
...
const UserAvatar = ({idUser}) => {
    ...
    return (
        <div className={styles.container} >
            <div >
                <img onError={(e)=>e.target.src =avatar} src={`https://localhost:7215/api/photos/getUserPhotoById?userId=${idUser}`}
